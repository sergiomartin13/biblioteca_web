...
class TestRepositorioFichero:
    ...
    def test_cargar_todas_vacio(self):
        publicaciones = self.repositorio.cargar_todas()
        assert publicaciones == []

    def test_cargar_todas_con_datos(self):
        with open(self.temp_file.name, 'w') as f:
            f.write("Libro;Libro 1;True\n")
    ...
    def test_borrar_existente(self):
        with open(self.temp_file.name, 'w') as f:
            ...
            f.write("Revista;Revista 1;False\n")
        self.repositorio.borrar("Libro 1")
        with open(self.temp_file.name, 'r') as f:
            content = f.read()
